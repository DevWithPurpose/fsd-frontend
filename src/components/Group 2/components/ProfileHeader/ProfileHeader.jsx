...
import marcus from "../../../../assets/Marcus Chen.png"
    ...
    <div className={styles.profileHeader}>
      <div className={styles.left}>
        ...
        <div className={styles.info}>
          ...
          <div>
            <h1 className={styles.name}>Marcus Chen</h1>
            <p className={styles.title}>Architect & Carpenter</p>
            <p className={styles.bio}>
              Architect by day, amateur carpenter by weekend. I love helping
              neighbors fix up their spaces or navigate local planning
              permissions.
            </p>
          </div>
        ...
        {impactError ? (
          ...
          <>
            <div className={styles.stats}>
              <div className={styles.statCard}>
                <span className={styles.statNumber}>
                  {communityImpact.neighborsHelped}
                </span>
                <span className={styles.statText}>Neighbors Helped</span>
              </div>
              <div className={styles.statCard}>
                <span className={styles.statNumber}>
                  {communityImpact.activePosts}
                </span>
            ...
            <div className={styles.meta}>
              <p>
                <MdOutlineLocationOn size={15} className={styles.metaIcon} />{" "}
                {communityImpact.location}
              </p>
              <p>
                <BsCalendar3 size={13} className={styles.metaIcon} /> Joined{" "}
                {communityImpact.joinedDate}
              </p>
            </div>
          </>
        ) : (
